符串‘platform’的结果。此功能也可以在编辑菜单中找到或通过快捷键使用。

![](images/ac587e5a657d4ba3d4ceff2a427a09707d101af4cf0d4d1a9ef24308f5efc198.jpg)

FindInFiles 功能提供了一种在多个文件中搜索字符串的方法。结果会显示在输出面板的FindResults 选项卡中，并列出所有匹配项。双击某个匹配项可以跳转到文本编辑器中的匹配位置。此功能也可以在编辑菜单中找到或通过快捷键使用。
...
LocalVariables：可以将活动行的局部变量添加到监视中。可以使用调用堆栈控制来更改